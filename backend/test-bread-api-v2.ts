/**
 * Test script to directly call Bread API with correct format
 */
...
async function testBreadIdentityAPI() {
  ...
  try {
    // Test 1: Create Identity (matching backend format)
    console.log('📝 Test 1: Creating Identity (backend format)...');
    const identityPayload = {
      type: 'Link', // Required by Bread API
      name: 'Test User',
      details: {
